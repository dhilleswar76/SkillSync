    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="bg-gradient-to-r from-primary via-coral to-secondary py-12">
        <div className="container mx-auto px-6">
          ...
          <p className="text-white/90 text-lg">Comprehensive courses to master every domain</p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-6 py-8">
        ...
        <div className="mb-6">
          <input
            ...
            className="w-full px-6 py-4 border border-gray-300 dark:border-gray-600 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary focus:border-transparent shadow-sm"
          />
        </div>
