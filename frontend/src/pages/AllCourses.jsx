...
const AllCourses = () => {
  ...
  const combinedTrackCourses = [
    {
      ...
      reviews: 1470,
      icon: '🧠',
      instructor: 'Dr. Sarah Chen & Prof. Michael Zhang',
      instructorTitle: 'Interview Preparation Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'A single end-to-end DSA track from fundamentals to FAANG-level advanced problem solving.',
      topics: ['Arrays to Graphs', 'Advanced DP', 'Segment Trees', 'Greedy + Bit Manipulation', 'Interview Patterns'],
      features: ['300+ problem roadmap', 'Beginner-to-advanced progression', 'Mock interviews', 'Capstone assessments'],
      externalResources: [
        { platform: 'TakeUforward', url: 'https://takeuforward.org/strivers-a2z-dsa-course/strivers-a2z-dsa-course-sheet-2', description: 'Comprehensive DSA sheet' },
        { platform: 'LeetCode', url: 'https://leetcode.com/studyplan/', description: 'Structured interview study plans' },
      ],
      practiceProblems: '300+ curated coding problems with weekly progression',
    },
    {
      ...
      reviews: 3050,
      icon: '🌍',
      instructor: 'Emma Rodriguez, James Wilson & Aisha Patel',
      instructorTitle: 'Frontend + Backend Engineering Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish', 'Portuguese'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'One complete web track covering frontend, React, backend APIs, databases, auth, deployment, and production projects.',
      topics: ['HTML/CSS/JS', 'React Ecosystem', 'Node/Express APIs', 'MongoDB & SQL', 'Auth, Testing, Deployment'],
      features: ['6 portfolio projects', 'Frontend + backend integration', 'Production deployment', 'Interview prep'],
      externalResources: [
        { platform: 'MDN', url: 'https://developer.mozilla.org/en-US/docs/Learn_web_development', description: 'Web development fundamentals' },
        { platform: 'freeCodeCamp', url: 'https://www.freecodecamp.org/learn', description: 'Hands-on full stack paths' },
      ],
      practiceProblems: '150+ frontend/backend tasks and full-stack milestones',
    },
    {
      ...
      reviews: 2010,
      icon: '🎨',
      instructor: 'Emma Rodriguez & James Wilson',
      instructorTitle: 'Frontend Engineering Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Complete frontend domain track from HTML/CSS/JavaScript to advanced React architecture and performance.',
      topics: ['HTML/CSS', 'JavaScript', 'Responsive UI', 'React', 'State Management', 'Frontend Performance'],
      features: ['4 frontend capstones', 'UI architecture patterns', 'Testing and accessibility', 'Production deployment'],
      externalResources: [
        { platform: 'MDN', url: 'https://developer.mozilla.org/en-US/docs/Learn_web_development', description: 'Frontend web fundamentals' },
        { platform: 'React Docs', url: 'https://react.dev/learn', description: 'Modern React learning path' },
      ],
      practiceProblems: '120+ UI tasks, React component challenges, and frontend projects',
    },
    {
      ...
      icon: '🧩',
      instructor: 'Aisha Patel',
      instructorTitle: 'Backend Engineering Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'End-to-end backend track covering APIs, databases, authentication, caching, queues, and deployment reliability.',
      topics: ['Node/Express', 'REST APIs', 'DBMS + MongoDB', 'Auth/Security', 'Caching/Queues', 'Observability'],
      features: ['API-first projects', 'Database design labs', 'Security hardening', 'Scalable backend architecture'],
      externalResources: [
        { platform: 'Node.js Docs', url: 'https://nodejs.org/en/learn', description: 'Backend runtime fundamentals' },
        { platform: 'Express Docs', url: 'https://expressjs.com/en/guide/routing.html', description: 'API and middleware design' },
      ],
      practiceProblems: '140+ backend API, database, and scalability exercises',
    },
    {
      ...
      instructorTitle: 'ML and Deep Learning Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Chinese', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Comprehensive ML engineering track from fundamentals to advanced deep learning and production deployment.',
      topics: ['ML Foundations', 'Feature Engineering', 'Modeling', 'Deep Learning', 'MLOps and Deployment'],
      features: ['Kaggle-driven projects', 'GPU-ready notebooks', 'MLOps workflow', 'Research-backed curriculum', 'Production case studies'],
      externalResources: [
        { platform: 'Kaggle Learn', url: 'https://www.kaggle.com/learn', description: 'Applied ML learning paths' },
        { platform: 'TensorFlow', url: 'https://www.tensorflow.org/tutorials', description: 'Deep learning tutorials' },
        { platform: 'scikit-learn', url: 'https://scikit-learn.org/stable/user_guide.html', description: 'ML algorithms and best practices' },
      ],
      practiceProblems: '120+ model-building, evaluation, and production exercises',
    },
    {
      ...
      reviews: 1290,
      icon: '📊',
      instructor: 'Dr. Ananya Rao & Prof. Miguel Santos',
      instructorTitle: 'Statistics and Data Science Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'End-to-end data science track covering statistics, ML, experimentation, and production data workflows.',
      topics: ['Statistics', 'EDA', 'Feature Engineering', 'ML Modeling', 'Experimentation', 'Data Storytelling'],
      features: ['Real datasets', 'Notebook pipelines', 'A/B testing modules', 'Model interpretation', 'Capstone projects'],
      externalResources: [
        { platform: 'Kaggle', url: 'https://www.kaggle.com/learn', description: 'Data science practical pathways' },
        { platform: 'Pandas Docs', url: 'https://pandas.pydata.org/docs/', description: 'Data wrangling and analysis reference' },
        { platform: 'StatQuest', url: 'https://www.youtube.com/c/joshstarmer', description: 'Statistics and ML intuition' },
      ],
      practiceProblems: '100+ real-world data science assignments and case studies',
    },
    {
      ...
      reviews: 1110,
      icon: '📈',
      instructor: 'Neha Verma & Daniel Brooks',
      instructorTitle: 'Analytics and BI Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Complete analytics track for SQL, BI dashboards, KPI design, and business decision-making with data.',
      topics: ['SQL Analytics', 'Data Modeling', 'BI Dashboards', 'KPIs', 'Storytelling', 'Business Decision Analytics'],
      features: ['Power BI/Tableau workflows', 'Case interview style analytics', 'Dashboard projects', 'Stakeholder reporting'],
      externalResources: [
        { platform: 'SQLBolt', url: 'https://sqlbolt.com/', description: 'Interactive SQL practice' },
        { platform: 'Power BI', url: 'https://learn.microsoft.com/en-us/training/powerplatform/power-bi/', description: 'Power BI analytics training' },
        { platform: 'Tableau', url: 'https://www.tableau.com/learn/training', description: 'Dashboard building and BI best practices' },
      ],
      practiceProblems: '90+ analytics tasks, dashboard sprints, and KPI case studies',
    },
    {
      id: 'cybersecurity-engineering-track',
      ...
      reviews: 1040,
      icon: '🛡️',
      instructor: 'Ritika Sharma & Omar Khalid',
      instructorTitle: 'Security Engineering Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Full cybersecurity domain track including web security, network defense, cloud security, and incident response.',
      topics: ['Security Fundamentals', 'Web App Security', 'Network Security', 'Cloud Security', 'Threat Modeling', 'Incident Response'],
      features: ['Hands-on labs', 'OWASP-focused modules', 'SOC workflows', 'Security audit projects'],
      externalResources: [
        { platform: 'OWASP', url: 'https://owasp.org/www-project-top-ten/', description: 'Top web security risks and defenses' },
        { platform: 'PortSwigger', url: 'https://portswigger.net/web-security', description: 'Practical web security labs' },
        { platform: 'NIST', url: 'https://www.nist.gov/cyberframework', description: 'Security framework and governance reference' },
      ],
      practiceProblems: '120+ security labs, hardening exercises, and incident simulations',
    },
    {
      ...
      reviews: 1910,
      icon: '🏛️',
      instructor: 'Prof. Thomas Anderson, Dr. Lisa Wang & Mark Stevens',
      instructorTitle: 'OS, Networks, and DBMS Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Focused CS fundamentals track combining operating systems, computer networks, and DBMS without system design overlap.',
      topics: ['Operating Systems', 'Computer Networks', 'DBMS', 'Concurrency', 'Storage and Query Processing'],
      features: ['Core interview prep', 'Systems labs', 'End-to-end revision track', 'Fundamentals-first progression'],
      externalResources: [
        { platform: 'GeeksforGeeks', url: 'https://www.geeksforgeeks.org/computer-science-projects/', description: 'CS core references and practice' },
        { platform: 'NPTEL', url: 'https://nptel.ac.in/courses', description: 'Academic CS fundamentals courses' },
      ],
      practiceProblems: '100+ OS, CN, and DBMS exercises with interview question sets',
    },
    {
      ...
      icon: '🏗️',
      instructor: 'Alex Morrison',
      instructorTitle: 'Principal Engineer and System Design Mentor',
      language: 'English',
      subtitles: ['English', 'Hindi'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Dedicated system design track focused on scalable architecture, reliability, and interview-grade design thinking.',
      topics: ['Requirements and Capacity', 'Distributed Systems', 'Caching and Queues', 'Consistency Models', 'Observability'],
      features: ['Architecture case studies', 'Design interviews', 'Trade-off analysis', 'Production scaling playbooks'],
      externalResources: [
        { platform: 'System Design Primer', url: 'https://github.com/donnemartin/system-design-primer', description: 'Structured system design prep' },
        { platform: 'Gaurav Sen', url: 'https://www.youtube.com/c/GauravSensei', description: 'System design interview videos' },
      ],
      practiceProblems: '80+ large-scale architecture case prompts and design reviews',
    },
    {
      ...
      instructorTitle: 'Cross-platform and Native Mobile Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Single mobile development track covering cross-platform React Native and native Android with Kotlin.',
      topics: ['React Native', 'Android Kotlin', 'App Architecture', 'Offline Data', 'Publishing & StoreOps'],
      features: ['4 app capstones', 'Store deployment', 'Native integrations', 'Performance tuning'],
      externalResources: [
        { platform: 'React Native Docs', url: 'https://reactnative.dev/docs/getting-started', description: 'Cross-platform app docs' },
        { platform: 'Android Developers', url: 'https://developer.android.com/guide', description: 'Official Android development guides' },
      ],
      practiceProblems: '60+ feature implementation challenges',
    },
    {
      ...
      icon: '⚙️',
      instructor: 'Robert Chen',
      instructorTitle: 'DevOps Architecture Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Dedicated DevOps track for CI/CD, containers, IaC, observability, and platform reliability engineering.',
      topics: ['CI/CD', 'Docker/Kubernetes', 'Terraform', 'Monitoring', 'Reliability Engineering'],
      features: ['Production pipelines', 'Platform engineering labs', 'SRE playbooks', 'Incident response drills'],
      externalResources: [
        { platform: 'roadmap.sh', url: 'https://roadmap.sh/devops', description: 'DevOps skill map' },
        { platform: 'Kubernetes', url: 'https://kubernetes.io/docs/tutorials/', description: 'Container orchestration tutorials' },
      ],
      practiceProblems: '90+ deployment automation and reliability scenarios',
    },
    {
      ...
      icon: '☁️',
      instructor: 'Rachel Brown',
      instructorTitle: 'Cloud Solutions Architecture Faculty',
      language: 'English',
      subtitles: ['English', 'Hindi', 'Spanish'],
      lastUpdated: 'March 2026',
      certificate: true,
      description: 'Comprehensive cloud computing track with architecture patterns, security, cost optimization, and multi-service deployments.',
      topics: ['Cloud Fundamentals', 'Compute/Storage', 'Networking', 'Security', 'HA/Scalability', 'Cost Optimization'],
      features: ['Cloud labs', 'Architecture design exercises', 'Certification-aligned modules', 'Production deployment patterns'],
      externalResources: [
        { platform: 'AWS Training', url: 'https://www.aws.training/', description: 'Cloud architecture pathways' },
        { platform: 'Azure Learn', url: 'https://learn.microsoft.com/en-us/training/azure/', description: 'Cloud platform learning modules' },
        { platform: 'Google Cloud Skills Boost', url: 'https://www.cloudskillsboost.google/', description: 'Cloud labs and guided projects' },
      ],
      practiceProblems: '100+ cloud architecture and operations scenarios',
    },
  ];
  ...
  const displayCourses = [
    ...combinedTrackCourses,
    ...courses.filter((course) => !mergedCourseIds.has(course.id)),
  ];
